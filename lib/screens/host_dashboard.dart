...
class HostDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder(
          future: Provider.of<HostPlacesProvider>(context, listen: false)
  ...
  Widget _buildPlaceCard(BuildContext context, Place place) {
    ...
    return FutureBuilder<List<Review>>(
      future: reviewService.getReviewsForPlace(place.id),
      builder: (context, snapshot) {
        int reviewCount = 0;
        if (snapshot.hasData) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            subtitle: Text("\$${place.price} per night • $reviewCount reviews"),
